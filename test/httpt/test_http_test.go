...
func Test(t *testing.T) {
	...
	mock.POST("/endpoint1", endpoint.NewDefaultHttp(func(ctx context.Context, w http.ResponseWriter, _ *http.Request) error {
		return json.NewEncoder(w).Encode(resp{Ok: true})
	}))
	mock.GET("/endpoint2", endpoint.NewDefaultHttp(func(ctx context.Context, w http.ResponseWriter, _ *http.Request) error {
