...
Добавляет сообщение к существующей ошибке. Если `err == nil`, возвращает `nil`.

#### `WithMessagef(err error, format string, args ...any) error`

Добавляет форматированное сообщение к существующей ошибке. Если `err == nil`, возвращает `nil`.
